...
[![Deploy](https://www.herokucdn.com/deploy/button.png)](https://dashboard.heroku.com/new?template=https://github.com/Hairwme/msskag)  
...
* **务必替换所有的b98d9fd8-8797-46cf-b059-b0e81e349379为部署时设置的AUUID**  
...
* 端口：443
* 默认UUID：b98d9fd8-8797-46cf-b059-b0e81e349379
* 加密：none
* 传输协议：ws
* 伪装类型：none
* 路径：/b98d9fd8-8797-46cf-b059-b0e81e349379-vless // 默认vless使用/$uuid-vless，vmess使用/$uuid-vmess
* 底层传输安全：tls
```
</details>
...
* 客户端下载: https://github.com/p4gefau1t/trojan-go/releases
{
    ...
    "remote_port": 443,
    "password": [
        "b98d9fd8-8797-46cf-b059-b0e81e349379"
    ],
    "websocket": {
        "enabled": true,
        "path": "/b98d9fd8-8797-46cf-b059-b0e81e349379-trojan",
...
* 插件选项: tls;host=appname.herokuapp.com;path=/b98d9fd8-8797-46cf-b059-b0e81e349379-ss
```
</details>
